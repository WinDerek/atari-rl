...
ax.plot(range(1, len(episode_reward_array) + 1), episode_reward_array, 'o', linestyle='-', color=COLOR, label="Episode reward", markersize=MARKER_SIZE, linewidth=LINE_WIDTH)
